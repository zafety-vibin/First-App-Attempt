/**
 * CreaturesLandingPage - Landing page for Creatures category
...
export const CreaturesLandingPage: React.FC = () => {
  ...
  return <CategoryLandingCanvas campaignId={campaignId} category="creatures" />;
};
