/**
 * CustomMechanicsLandingPage - Landing page for Custom Mechanics category
...
export const CustomMechanicsLandingPage: React.FC = () => {
  ...
  return <CategoryLandingCanvas campaignId={campaignId} category="custom_mechanics" />;
};
