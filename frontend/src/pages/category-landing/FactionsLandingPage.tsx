/**
 * FactionsLandingPage - Landing page for Factions category
...
export const FactionsLandingPage: React.FC = () => {
  ...
  return <CategoryLandingCanvas campaignId={campaignId} category="factions" />;
};
