/**
 * ItemsLandingPage - Landing page for Items category
...
export const ItemsLandingPage: React.FC = () => {
  ...
  return <CategoryLandingCanvas campaignId={campaignId} category="items" />;
};
