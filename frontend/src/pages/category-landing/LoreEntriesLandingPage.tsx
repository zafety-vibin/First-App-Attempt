/**
 * LoreEntriesLandingPage - Landing page for Lore Entries category
...
export const LoreEntriesLandingPage: React.FC = () => {
  ...
  return <CategoryLandingCanvas campaignId={campaignId} category="lore_entries" />;
};
