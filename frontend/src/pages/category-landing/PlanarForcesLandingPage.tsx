/**
 * PlanarForcesLandingPage - Landing page for Planar Forces category
...
export const PlanarForcesLandingPage: React.FC = () => {
  ...
  return <CategoryLandingCanvas campaignId={campaignId} category="planar_forces" />;
};
