/**
 * SessionPrepLandingPage - Landing page for Session Prep category
...
export const SessionPrepLandingPage: React.FC = () => {
  ...
  return <CategoryLandingCanvas campaignId={campaignId} category="session_prep" />;
};
