/**
 * WorldRulesLandingPage - Landing page for World Rules category
...
export const WorldRulesLandingPage: React.FC = () => {
  ...
  return <CategoryLandingCanvas campaignId={campaignId} category="world_rules" />;
};
